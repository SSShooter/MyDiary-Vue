<template>
  <div class="home">
    <modal name="new-folder" :width="300" :height="200">
    ...
    <div id="main">
      <div v-for="item in items" class="item" :data-folderid="item._id" :data-type="item.type" @click="jump" :key="item._id">
    ...
    <footer>
      ...
      <i class="iconfont icon-setting cog"  @click="isModalShow=!isModalShow"></i>
    </footer>
